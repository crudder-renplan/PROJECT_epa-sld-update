__title__ = 'renplan-project'
__version__ = '0.0.0'
__author__ = 'Renaissance Planning'
__license__ = 'Apache 2.0'
__copyright__ = 'Copyright 2020 by Renaissance Planning'
...
def example_function(in_path: Union[str, Path]) -> pd.DataFrame:
    ...
    .. code-block:: python
        ...
        from renplan_project import example_function
...
class ExampleObject(object):
    ...
    def example_static_function(in_path: Union[str, Path]) -> pd.DataFrame:
        ...
        .. code-block:: python
            ...
            from renplan_project import ExampleObject
    ...
    def example_class_method(cls):
        ...
        .. code-block:: python
            ...
            from from renplan_project import ExampleObject
